...
def test_context_fundamentals_sentiment_are_yaml_controlled():
    ...
    assert features['families']['fundamentals']['presets']['temporal_cvm_safe']['features']['regime_score'] is True
    assert 'enabled_by_default' not in features['families']['sentiment']['presets']['temporal_cache']
